...
import { ordersLink, productsLink } from './links';
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <Send sendCommand={this.sendCommand} />
        <Cancel />
        <RenderCommand delete={this.delete} order={this.state.order} />
        <MenuItems menu={this.state.menu} addProduct={this.addProduct} />
      </React.Fragment>
    );
  }
}
